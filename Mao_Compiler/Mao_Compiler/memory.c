...
void add_int_variable(_name_string _name, int _value) {
...
void add_double_variable(_name_string _name, double _value) {
	_memory *p_node = (_memory *)malloc(sizeof(_memory));
...
_variable get_variable_by_name(_name_string _name) {
	_memory *p_current = p_head;
...
_type get_type_by_name(_name_string _name) {
	return get_variable_by_name(_name).type;
}

int get_int_value_by_name(_name_string _name) {
	return get_variable_by_name(_name).int_value;
}

double get_double_value_by_name(_name_string _name) {
	return get_variable_by_name(_name).double_value;
}
